...
const initialData = [
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que el \u00faltimo al que llega es el 0, debido a que $-4+4=0$"
			},
			{
				answerText: "piso 4, piso 7 y piso 11.",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que el primer piso al que llega es $0+3=3$, luego $3-7=-4$ y finalmente $-4+4=0$"
			},
			{
				answerText: "piso 4, piso -7 y piso 11.",
				isCorrect: false,
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "Se debe hacer $80.000-100.000$, ya que se est\u00e1 abonando a la deuda, la cual se relaciona con el signo negativo.",
				isCorrect: true,
				feedback:
			...
			{
				answerText: "Se debe sumar $100.000$ con $80.000$, ya que la palabra deber se relaciona con sumar los montos.",
				isCorrect: false,
				feedback:
			...
			{
				answerText: "Se debe hacer $100.000-80.000$, ya que si yo debo algo, al pagarlo se me descuenta dinero.",
				isCorrect: false,
				feedback:
					"Esta respuesta no es correcta, ya que la deuda (negativo) es de $100.000$ y al pagar parte de la deuda esta debe disminuir, por lo que necesariamente $80.000$ tiene signo positivo."
			},
			{
				answerText: "Se debe hacer $-100.000-80.000$, ya que la situaci\u00f3n habla de deudas, las cuales se asocian con el signo negativo.",
				isCorrect: false,
				feedback:
					"Esta respuesta no es correcta, ya que la deuda (negativo) es de $100.000$ y al pagar parte de la deuda esta debe disminuir, por lo que necesariamente $80.000$ tiene signo positivo."
			}
	...
	},
	{
		...
		imageURL: "C:\\Users\\paula\\Desktop\\im\u00e1genes_labcat\\p5.svg",
		figureCaption: "Figura 1",
		node_id: 4,
		dificulty: "Media ",
		alternatives: [
			{
				answerText: "El error est\u00e1 en que debi\u00f3 haber sumado 4, ya que $- \\cdot -=+$, por lo que deber\u00eda haberse movido a la derecha",
				isCorrect: true,
				feedback: "Esta alternativa es correcta, ya que la multiplicaci\u00f3n de signos iguales siempre da como resultado un signo positivo."
			},
			{
				answerText: "El error est\u00e1 en que el resultado no es -6, sino que es 6.",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que el resultado correcto es 2, contando 4 espacios hacia la derecha."
			},
			{
				answerText: "El error est\u00e1 en que no debe contar 4 posiciones desde el -2, sino que desde el 0.",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que la operaci\u00f3n pide operar respecto al -2, por lo que ese es el n\u00famero desde el cual se cuenta."
			},
			{
				answerText: "El error est\u00e1 en que el resultado no es -6, sino que -5, ya que se debe contar desde el 2.",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que se deben 4 movimientos, no 4 n\u00fameros."
			}
		]
	},
	{
		...
		alternatives: [
			{
				answerText: "El producto entre 0.7 y un n\u00famero es el 75\\% del n\u00famero.",
				isCorrect: true,
			...
			},
			{
				...
				isCorrect: false,
				feedback: "La afirmaci\u00f3n es correcta, ya que al dividir 1 entre 2, se obtiene 0.5, que es lo mismo que $\\frac{50}{100}$ en fracci\u00f3n, y en este caso, representa el 50\\%."
			},
			{
				answerText: "El 20\\% de un n\u00famero es el producto entre 0.2 y un n\u00famero.",
				isCorrect: false,
				feedback: "La afirmaci\u00f3n es verdadera, ya que 0.2 es $\\frac{20}{100}$ en fracci\u00f3n, y al multiplicar 20 y dividir por 100, se obtiene el 20\\% de un n\u00famero."
			},
			{
				answerText: "$\\frac{2}{4}$ de un n\u00famero cualquiera es el 50\\% de este.",
				isCorrect: false,
				feedback: "La afirmaci\u00f3n es correcta, ya que al simplificar $\\frac{2}{4}$ se obtiene $\\frac{1}{2}$, que es   lo mismo que 50\\%."
			}
		]
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "El planteamiento de la transformaci\u00f3n del porcentaje a fracci\u00f3n es al rev\u00e9s."
			},
			{
				answerText: "Dividir el n\u00famero por 40 y dividirlo por 100.",
				isCorrect: false,
				feedback: "El planteamiento de la transformaci\u00f3n del porcentaje a fracci\u00f3n es correcto, pero la operaci\u00f3n es incorrecta."
			},
			{
				answerText: "Multiplicar el n\u00famero por 100 y multiplicarlo por 40.",
				isCorrect: false,
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "Para saber el porcentaje de descuento de un producto se puede restar el valor original y el valor con descuento, dividirlo por el valor original y multiplicarlo por 100.",
				isCorrect: false,
				feedback: "El estudiante reconoce como obtener el porcentaje que se disminuye el valor original."
			},
			{
				answerText: "Es posible saber el valor original de un producto si se toma el valor con descuento y se divide por el procentaje de descuento como proporci\u00f3n.",
				isCorrect: false,
				feedback: "El estudiante reconoce como aplicar el porcentaje correctamente."
			},
			{
				answerText: "Se puede saber el valor final de un producto si se multiplica el valor original por el porcentaje de descuento y se divide por el mismo valor.",
				isCorrect: false,
				feedback: "El estudiante no reconoce como aplicar directamente el porcentaje de un n\u00famero."
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "$$ \\left(1+\\left(\\dfrac{k}{100}\\right) \\right)\\cdot X $$",
				isCorrect: false,
				feedback: "El estudiante reconoce el modelamiento del c\u00e1lculo de porcentaje mencionado."
			},
			{
			...
			},
			{
				...
				isCorrect: false,
				feedback: "El estudiante sabe como aplicar el c\u00e1lculo de porcentaje para un n\u00famero cualquiera pero no reconoce lo que se pide en el enunciado."
			},
			{
				answerText: "Todas las snteriores.",
				isCorrect: false,
				feedback: "El estudiante no reconoce que una de las respuestas es incorrecta."
			}
		]
	},
	{
		...
		alternatives: [
			...
			},
			{
				answerText: "-10\u00b0C",
				isCorrect: false,
				feedback: "Esta alternativa corresponde a sumar ambas temperaturas, pero la pregunta pide la variaci\u00f3n de esta, por lo que la operaci\u00f3n a realizar es la sustracci\u00f3n"
			},
			{
				answerText: "-6\u00b0C",
				isCorrect: false,
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "$$\\dfrac{1}{5} \\ de \\ un\\ valor\\ corresponde\\ al\\ 20\\%\\ de\\ \u00e9ste.$$",
				isCorrect: false,
				feedback: "El estudiante reconoce la relaci\u00f3n entre una fracci\u00f3n y el procenaje."
			},
			{
				answerText: "$$El\\ 0,3\\ de\\ un\\ n\u00famero\\ corresponde\\ al\\ 30\\%\\ de\\ \u00e9ste.$$",
				isCorrect: false,
				feedback: "El estudiante reconoce la relaci\u00f3n entre porcentaje y proporci\u00f3n."
			},
			{
				answerText: "$$\\dfrac{3}{4}\\ de\\ un\\ n\u00famero\\ corresponde\\ a\\ 75\\%\\ del\\ mismo\\ n\u00famero$$",
				isCorrect: false,
				feedback: "El estudiante reconoce la relaci\u00f3n entre una fracci\u00f3n y el procenaje."
			},
			{
				answerText: "$$El\\ 20\\%\\ de\\ un\\ n\u00famero,\\ es\\ el\\ n\u00famero\\ multiplicado\\ por\\ 20.$$",
				isCorrect: false,
	...
	},
	{
		...
		imageURL: "C:\\Users\\paula\\Desktop\\im\u00e1genes_labcat\\porcentajes.svg",
		figureCaption: "Figura 1",
		node_id: 3,
		dificulty: "Media ",
		alternatives: [
			{
				answerText: "$25\\%$",
				isCorrect: true,
				feedback: "Esta alternativa es correcta, ya que al tener 100 cuadrados, los pintados son 25 de 100, es decir, 25\\%"
			},
			{
				answerText: "$\\frac{1}{4}$",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que si bien representa la cantidad de cuadrados pintados, no est\u00e1 en formato de porcentaje."
			},
			{
			...
			},
			{
				answerText: "$75$",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que representa la cantidad de cuadrados que no est\u00e1n pintados."
			}
		]
	},
	{
		...
		imageURL: "C:\\Users\\paula\\Desktop\\im\u00e1genes_labcat\\barras.svg",
		figureCaption: "Figura 1",
		node_id: 3,
		dificulty: "Media ",
		alternatives: [
			{
				answerText: "$37,5\\%$",
				isCorrect: true,
				feedback: "Esta alternativa es correcta, ya que resulta de calcular $\\frac{100}{x}=\\frac{8}{3}$"
			},
			{
				answerText: "$3\\%$",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que corresponde a solo contar la cantidad de trozos pintados"
			},
			{
				answerText: "$30\\%$",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que considera que la bater\u00eda est\u00e1 dividida en 100 partes, pero en realidad est\u00e1 dividida en 8"
			},
			{
				answerText: "$0,375\\%$",
				isCorrect: false,
				feedback: "Esta alternativa no es correcta, ya que corresponde a realizar correctamente la divisi\u00f3n de 3 con 8, pero falta multiplicar por 100 para obtener el porcentaje."
			}
		]
	},
	{
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Resulta de la omitir la particion inicial en tres, es decir, considera solo repartir el total en sus dos amigos."
			},
			{
				answerText: "$2a+6$",
				isCorrect: false,
				feedback: "Resulta de triplicar la cantidad en vez de sacar la tercera parte de los juguetes."
			},
			{
				answerText: "$\\frac{a+3}{3}$",
				isCorrect: false,
				feedback: "Considera dividir la cantidad repartida nuevamente en tres a sus dos amigos."
			}
		]
	},
	{
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				answerText: "N = 2M + 2P",
				isCorrect: false,
				feedback: "La relaci\u00f3n se construye mal, se comprende mal la equivalencia entre los plantanos y naranjas."
			},
			{
				answerText: "N = 2M - 2P",
				isCorrect: false,
				feedback: "La relaci\u00f3n se resta y se construye mal, se refuerza el distractor anterior."
			}
		]
	},
	{
		...
		alternatives: [
			...
			{
				answerText: "Si hay \\(10\\) manzanas, entonces hay m\u00e1s peras que naranjas.",
				isCorrect: false,
				feedback: "Feedback cuando seleccionan esta respuesta"
			}
		]
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "Cuando una variable aumenta, la otra disminuye en una proporci\u00f3n constante.",
				isCorrect: false,
				feedback: "El estudiante reconoce la definici\u00f3n de proporcionalidad inversa."
			},
			{
				answerText: "Cuando una variable aumenta, la otra aumenta en una proporci\u00f3n constante.",
				isCorrect: false,
				feedback: "El estudiante no recoce la definici\u00f3n de proporcionalidad inversa."
			},
			{
		...
		alternatives: [
			{
				...
				isCorrect: true,
				feedback: "La expresi\u00f3n corresponde a una raz\u00f3n, ya que es una relaci\u00f3n entre dos cantidades mediante una divisi\u00f3n."
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "Una relaci\u00f3n directa se puede expresar como $\\dfrac{Y}{X} = a$",
				isCorrect: false,
				feedback: "El estudiante reconoce la forma algebraica de una relaci\u00f3n directa."
			},
			{
				answerText: "Una relaci\u00f3n inversa se puede representar como $Y \\cdot X = a$",
				isCorrect: false,
				feedback: "El estudiante reconoce la forma algebraica de una relaci\u00f3n inversa."
			},
			{
				answerText: "Una relaci\u00f3n directa se puede expresar como $X+Y = a$",
				isCorrect: false,
				feedback: "El estudiante no reconoce la forma algebraica de una relaci\u00f3n directa."
			},
			{
				answerText: "Una relaci\u00f3n inversa se puede expresar como $\\dfrac{Y}{X} = -a$",
				isCorrect: false,
				feedback: "El estudiante no reconoce la forma algebraica de una relaci\u00f3n directa."
			}
		]
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Se aplica bien el concepto de punto medio, sin embargo, los ejes estan mal posicionados con respecto a la imagen."
			},
			{
				answerText: "$$(\\frac{x_2 + y_2}{2}, \\frac{x_1 + y_1}{2})$$",
				isCorrect: false,
				feedback: "Se reutiliza la idea del primer distractor, sin embargo, tambien se denota la confusi\u00f3n de ubicar mal la numeraci\u00f3n."
			}
		]
	},
	{
		...
		alternatives: [
			{
				...
				isCorrect: true,
				feedback: "Al ubicar los puntos en un plano cartesiano, se obtiene lo siguiente:"
			},
			{
		...
		alternatives: [
			{
				answerText: "\\(3\\)",
				isCorrect: true,
				feedback: "La respuesta a la cantidad de horas que m\u00e1s se repite es \\(10\\) y esta se repite \\(3\\) veces, por lo que su frecuencia absoluta es \\(3\\)"
			},
			{
				answerText: "\\(10\\)",
				isCorrect: false,
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				answerText: "a = 5 ; b = 10",
				isCorrect: false,
				feedback: "Resulta de la confusi\u00f3n de aplicar los valores invertidos."
			},
			{
				answerText: "a = 14 ; b = 19",
				isCorrect: false,
				feedback: "Resulta de seguir la logica en la edad de 18 a\u00f1os, ya que su frecuencia absoluta y acumulada coincide."
			},
			{
				answerText: "a = 4 ; b = 14",
				isCorrect: false,
				feedback: "Resulta de no realizar la resta y poner la frecuencia acumulada anterior."
			}
		]
	},
	{
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Solo se considera el primer intervalo, lo que corresponde al 20\\%."
			},
			{
	...
	},
	{
		...
		alternatives: [
			{
				answerText: "el $75\\%$ de los chicles son de sabor sand\u00eda y menta",
				isCorrect: true,
				feedback: "Feedback cuando seleccionan esta respuesta"
			},
			{
				...
				isCorrect: false,
				feedback: "La afirmacion puede resultar confusa, porque al haber reposicion, existe la probabilidad de sacar sabores que no est\u00e9n anotados en m\u00e1s de 8 intentos"
			},
			{
				answerText: "el 30\\% de los chicles son sabor sand\u00eda",
				isCorrect: false,
				feedback: "Puede existir la confusion al calcular la frecuencia relativa del sabor sandia, ya que al haber tres chicles, se puede pensar que son el 30\\%."
			},
			{
	...
	},
	{
		...
		imageURL: "img/54_3 Gr\u00e1fico circular.svg",
		figureCaption: "Figura 1",
		node_id: 16,
		dificulty: "Baja",
		alternatives: [
			{
				answerText: 'La frecuencia relativa de los que contestan "Muy de acuerdo" es \\(\\dfrac{3}{10}\\).',
				isCorrect: true,
				feedback: "Feedback cuando seleccionan esta respuesta"
			},
			{
			...
			{
				answerText: "Hay \\(8\\) estudiantes m\u00e1s que contestaron \u201cNi de acuerdo ni en desacuerdo\u201d que los que contestaron \u201cMuy de acuerdo\u201d.",
				isCorrect: false,
				feedback: "Feedback cuando seleccionan esta respuesta"
			},
			{
				answerText: "M\u00e1s de la mitad de los estudiantes respondi\u00f3 la opci\u00f3n \u201cNi de acuerdo ni en desacuerdo\u201d.",
				isCorrect: false,
				feedback: "Feedback cuando seleccionan esta respuesta"
			}
		]
	...
	},
	{
		...
		imageURL: "./55_2imgpreg.svg",
		figureCaption: "Figura 1",
		node_id: 16,
		dificulty: "Media",
		alternatives: [
			{
				answerText: "Entre 2018 y 2022 no existe variaci\u00f3n con los resultados de las votaciones.",
				isCorrect: true,
				feedback: "Feedback cuando seleccionan esta respuesta"
			},
			{
				answerText: "Entre 2017 y 2020 existe variaci\u00f3n con los resultados de las votaciones promedio.",
				isCorrect: false,
				feedback: "Es otro caso parecido al de la respuesta, pero este caso es correcto porque existe variaci\u00f3n en el intervalo en los a\u00f1os 2018 y 2019."
			},
			{
				answerText: "En 2015 y 2019 fueros los a\u00f1os donde se vot\u00f3 menos en promedio.",
				isCorrect: false,
				feedback: "Correcto, ya que 2015 y 2019 registran los peores casos de votaciones en promedio"
			},
			{
				answerText: "en 2016 y 2017 hubo mas votos en promedio que en 2020 y 2022",
				isCorrect: false,
				feedback: "La afirmacion es correcta, ya que la suma de los votos en promedio de los a\u00f1os 2016 y 2017 es 55 y la suma en los a\u00f1os 2020 y 2022 es 50."
			}
		]
	},
	{
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Resulta de considerar que en cada intento pierda o gane su apuesta inicial y no la mitad."
			},
			{
				answerText: "En seis intentos Roberto puede quedar sin dinero.",
				isCorrect: false,
				feedback: "Resulta de considerar dos intentos anteriores, sin embargo, solo se piden los adicionales"
			},
			{
	...
	},
	{
		...
		alternatives: [
			...
			{
				answerText: "La frecuencia relativa del intervalo [ 1 - 2 [ es: $$\\dfrac{f_1}{f_6}$$",
				isCorrect: false,
		...
		alternatives: [
			{
				answerText: "\\(5\\)",
				isCorrect: true,
				feedback: "\\(560\\) corresponde a la mayor\u00eda de los estudiantes y estos inscriben \\(5\\) asignaturas durante su \u00faltimo a\u00f1o de estudio."
			},
			{
				answerText: "\\(4\\)",
				isCorrect: false,
	...
	},
	{
		...
		alternatives: [
			...
			},
			{
				...
				isCorrect: false,
				feedback: "Resulta de confunsi\u00f3n de considerar la frecuencia relativa."
			},
			{
				answerText: "A = 3, B = 10, C = 20, D = 24, E = 30",
				isCorrect: false,
				feedback: "Resulta de confunsi\u00f3n de considerar la frecuencia acumulada."
			},
			{
				answerText: "A = 3/30, B = 10/30, C = 20/30, D = 24/30, E = 30/30",
				isCorrect: false,
				feedback: "Resulta de confunsi\u00f3n de considerar la frecuencia relativa acumulada."
			}
		]
	}
];
