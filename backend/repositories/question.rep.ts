import { CreateOptions, FindOptions, DestroyOptions, WhereOptions } from "sequelize";
import sequelize, { Question as Entity, Alternative } from "../loaders/sequelize";
import { NotFoundError, InternalServerError } from "../error/customErrors";
import { IQuestion as I, ICreateQuestion as ICreate, IUpdateQuestion as IUpdate } from "../interfaces/question";
...
export default class QuestionRepository {
	...
	async findOne(where: WhereOptions<I>, options?: FindOptions): Promise<I | undefined> {
