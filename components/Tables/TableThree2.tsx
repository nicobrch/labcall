		...
		<div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
			<div className="max-w-full overflow-x-auto">
				<div className="flex justify-end mb-4">
					<select name="" id="" className="relative z-20 inline-flex py-2 pl-3 pr-8 text-sm font-medium outline-none" onChange={handleSelectChange} value={selectedOption}>
				...
				<table className="w-full table-auto">
					<thead>
						<tr className="bg-gray-2 text-left dark:bg-meta-4">
							{headers.map((header) => (
								<th key={header.key} colSpan={header.colSpan} className={`py-4 px-4 font-medium text-black dark:text-white xl:pl-11 `}>
									{header.label}
								</th>
							))}
						</tr>
