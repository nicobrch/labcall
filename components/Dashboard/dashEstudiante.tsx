      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <p className="items-center justify-center mt-4.5">
              {/* pendiente */}
            Bienvenido a la aplicacion de apoyo a la enseñanza de matematicas, para comenzar a usar la aplicacion, debes responder el test de diagnostico, el cual se encuentra en la seccion de test.
          </p>
        </div>
        {/* frase del dia */}
        {/* <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
