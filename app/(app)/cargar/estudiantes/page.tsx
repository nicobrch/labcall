...
const CargarExcelEstudiantes = () => {
  ...
  const validateForm = () => {
    if (course.trim() === "") {
      alert(
        'Por favor, elija un curso antes de subir el archivo.'
      );
      return false;
    }
    if (file === undefined) {
      alert(
        'Por favor, suba un archivo antes de enviar.'
      );
      return false;
    }
    if (file && !file.name.endsWith(".xlsx")) {
      alert(
        'Por favor, asegurese de subir un archivo de tipo Excel .XLSX'
      );
      return false;
    }
    return true;
    ...
    <>
      ...
      <div className="mx-auto max-w-screen-md rounded-sm border mb-6 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="flex flex-col gap-5 p-6">
          Asegúrate de descargar la planilla de excel y seguir el formato que este posee, antes de subir el archivo e intentar cargar los estudiantes. Esto evitará errores de ingreso.
          {/* <!-- Boton Submit --> */}
          <a href="/docs/Formato_Cargar_Estudiantes.xlsx" className="inline-flex items-center justify-center rounded-md bg-meta-3 py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10" download>
            <span>
