	...
	return (
		<>
			<div className="absolute z-9999 top-5 right-5 ">
				<AlertConfirmacion title={"Curso agregado con éxito!"} body={"Ya puedes asignarle estudiantes."} show={showAlertOK} setShow={setShowAlertOK}></AlertConfirmacion>
				<AlertError title={"No se puedo agregar curso :("} body={"Intente nuevamente."} show={showAlertError} setShow={setShowAlertError}></AlertError>
			</div>
					...
					<div className="col-span-5 xl:col-span-3">
						<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
							...
							<div className="p-7">
								...
								<div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
									<div className="w-full">
										<label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="text">
											Descripcion
										</label>
										<div>
											<textarea
								...
								<div className="flex justify-center gap-4.">
									<button onClick={fetchGuardarCurso} className="flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-95" type="submit">
										Crear Curso
									</button>
								</div>
							</div>
