...
// TODO: sidebar profesor
// se debe hacer una separacion con respecto a la sidebar que tendra el profesor y el estudiante
          ...
          <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
            ...
            <div>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <Link
                    href="/agregar_estudiante"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname?.includes("agregar_estudiante") &&
                      "bg-graydark dark:bg-meta-4"
                    }`}
                  >
                    <svg
                ...
                <li>
                  <Link
                    href="/lista_estudiantes"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname?.includes("lista_estudiantes") &&
                      "bg-graydark dark:bg-meta-4"
                    }`}
                  >
                    <svg
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/ui" || (pathname as any).includes("ui")
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                href="/asignacion/asignar_nodos"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/asignacion/asignar_nodos" &&
                                  "text-white"
                                }`}
                              >
                                Asignar Nodos
                            ...
                            <li>
                              <Link
                                href="/asignacion/preguntas"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/asignacion/preguntas" &&
                                  "text-white"
                                }`}
                              >
                                Preguntas
